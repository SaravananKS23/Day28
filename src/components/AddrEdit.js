...
const navigate=useNavigate();
    const {values,errors,handleBlur,handleChange,handleSubmit}= useFormik({
        ...
        onSubmit:(data)=>{
            if(values.id){
                axios.put(`https://61ab2ffbbfb110001773f42f.mockapi.io/products/${editdata.id}`,
                {
                ...
                axios.post('https://61ab2ffbbfb110001773f42f.mockapi.io/products',
           {
                productname:data.productname,
                image:data.image,
                price:data.price,
   ...
   <div >
            ...
            <form onSubmit={handleSubmit} style={{textAlign:'justify',border:'2px solid black',margin:'100px 300px',padding:'50px',background:'lightgray'}}>
